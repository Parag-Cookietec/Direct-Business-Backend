 ...
 */
@Entity
@Table(name = "TDOI_DB_PROP_MIT_RI_DTL", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropMitRiDtlEntity.findAll", query = "SELECT t FROM TdoiDbPropMitRiDtlEntity t")
public class TdoiDbPropMitRiDtlEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "PROP_MIT_RI_DTL_ID", unique = true, nullable = false)
	...
	public TdoiDbPropMitRiDtlEntity() {
	}
