...
/**
 * The persistent class for the TDOI_DB_PROPOSL_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_PROPOSL_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbProposlWfEntity.findAll", query = "SELECT t FROM TdoiDbProposlWfEntity t")
public class TdoiDbProposlWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_PROPOSL_WF_ID", unique = true, nullable = false)
	private long dbProposlWfId;
	...
	public TdoiDbProposlWfEntity() {
	}

	public long getDbProposlWfId() {
		return this.dbProposlWfId;
	}

	public void setDbProposlWfId(long dbProposlWfId) {
		this.dbProposlWfId = dbProposlWfId;
	}
