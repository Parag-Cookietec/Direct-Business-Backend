 ...
 */
@Entity
@Table(name = "TDOI_DB_PROPSL_AVIATION", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropslAviationEntity.findAll", query = "SELECT t FROM TdoiDbPropslAviationEntity t")
public class TdoiDbPropslAviationEntity extends BaseEntity {
	private static final Long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "PROP_AVIATION_ID", unique = true, nullable = false)
	...
	// bi-directional many-to-one association to TdoiDbPropslAviationWf
	@OneToMany(mappedBy = "tdoiDbPropslAviation",fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPropslAviationWfEntity> tdoiDbPropslAviationWfs;

	// bi-directional many-to-one association to TdoiDbPropAviationAircraft
	@OneToMany(mappedBy = "tdoiDbPropslAviation",fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPropAviationAircraftEntity> tdoiDbPropAviationAircrafts;

	// bi-directional many-to-one association to TdoiDbPropAviationRiDtl
	@OneToMany(mappedBy = "tdoiDbPropslAviation",fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPropAviationRiDtlEntity> tdoiDbPropAviationRiDtls;

	public TdoiDbPropslAviationEntity() {
	}
	...
	public List<TdoiDbPropslAviationWfEntity> getTdoiDbPropslAviationWfs() {
		return this.tdoiDbPropslAviationWfs;
	}

	public void setTdoiDbPropslAviationWfs(List<TdoiDbPropslAviationWfEntity> tdoiDbPropslAviationWfs) {
		this.tdoiDbPropslAviationWfs = tdoiDbPropslAviationWfs;
	}

	public TdoiDbPropslAviationWfEntity addTdoiDbPropslAviationWf(TdoiDbPropslAviationWfEntity tdoiDbPropslAviationWf) {
	...
	public TdoiDbPropslAviationWfEntity removeTdoiDbPropslAviationWf(
			TdoiDbPropslAviationWfEntity tdoiDbPropslAviationWf) {
	...
	public List<TdoiDbPropAviationAircraftEntity> getTdoiDbPropAviationAircrafts() {
		return this.tdoiDbPropAviationAircrafts;
	}

	public void setTdoiDbPropAviationAircrafts(List<TdoiDbPropAviationAircraftEntity> tdoiDbPropAviationAircrafts) {
		this.tdoiDbPropAviationAircrafts = tdoiDbPropAviationAircrafts;
	}

	public TdoiDbPropAviationAircraftEntity addTdoiDbPropAviationAircraft(
			TdoiDbPropAviationAircraftEntity tdoiDbPropAviationAircraft) {
	...
	public TdoiDbPropAviationAircraftEntity removeTdoiDbPropAviationAircraft(
			TdoiDbPropAviationAircraftEntity tdoiDbPropAviationAircraft) {
	...
	public List<TdoiDbPropAviationRiDtlEntity> getTdoiDbPropAviationRiDtls() {
		return this.tdoiDbPropAviationRiDtls;
	}

	public void setTdoiDbPropAviationRiDtls(List<TdoiDbPropAviationRiDtlEntity> tdoiDbPropAviationRiDtls) {
		this.tdoiDbPropAviationRiDtls = tdoiDbPropAviationRiDtls;
	}

	public TdoiDbPropAviationRiDtlEntity addTdoiDbPropAviationRiDtl(
			TdoiDbPropAviationRiDtlEntity tdoiDbPropAviationRiDtl) {
	...
	public TdoiDbPropAviationRiDtlEntity removeTdoiDbPropAviationRiDtl(
			TdoiDbPropAviationRiDtlEntity tdoiDbPropAviationRiDtl) {
