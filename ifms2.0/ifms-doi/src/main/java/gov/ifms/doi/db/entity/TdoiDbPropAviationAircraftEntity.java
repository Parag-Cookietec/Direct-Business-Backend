 ...
 */
@Entity
@Table(name = "TDOI_DB_PROP_AVIATION_AIRCRAFT", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropAviationAircraftEntity.findAll", query = "SELECT t FROM TdoiDbPropAviationAircraftEntity t")
public class TdoiDbPropAviationAircraftEntity extends BaseEntity {
	...
	public TdoiDbPropAviationAircraftEntity() {
	}
