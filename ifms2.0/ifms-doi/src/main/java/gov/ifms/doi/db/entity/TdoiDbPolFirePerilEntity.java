...
public class TdoiDbPolFirePerilEntity extends BaseEntity {
	...
	@OneToMany(mappedBy = "tdoiDbPolFirePeril",fetch = FetchType.LAZY,cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPolFireRiskLocEntity> tdoiDbFireRiskLocs;
	...
	public List<TdoiDbPolFireRiskLocEntity> getTdoiDbFireRiskLocs() {
		return tdoiDbFireRiskLocs;
	}

	public void setTdoiDbFireRiskLocs(List<TdoiDbPolFireRiskLocEntity> tdoiDbFireRiskLocs) {
		this.tdoiDbFireRiskLocs = tdoiDbFireRiskLocs;
	}

	public TdoiDbPolFireRiskLocEntity addTdoiDbPolFireRiskLocEntity(TdoiDbPolFireRiskLocEntity entity){
		getTdoiDbFireRiskLocs().add(entity);
		entity.setTdoiDbPolFirePeril(this);
		return entity;
	}

	public TdoiDbPolFireRiskLocEntity removeTdoiDbPolFireRiskLocEntity(TdoiDbPolFireRiskLocEntity entity){
		getTdoiDbFireRiskLocs().remove(entity);
		entity.setTdoiDbPolFirePeril(this);
		return entity;
	}
