...
/**
 * The persistent class for the TDOI_DB_POL_MIT_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_POL_MIT_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolMitWfEntity.findAll", query = "SELECT t FROM TdoiDbPolMitWfEntity t")
public class TdoiDbPolMitWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_POL_MIT_WF_ID", unique = true, nullable = false)
	private long dbPolMitWfId;
	...
	public TdoiDbPolMitWfEntity() {
	}

	public long getDbPolMitWfId() {
		return this.dbPolMitWfId;
	}

	public void setDbPolMitWfId(long dbPolMitWfId) {
		this.dbPolMitWfId = dbPolMitWfId;
	}
