 ...
 */
@Entity
@Table(name = "TDOI_DB_POL_FIRE_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolFireWfEntity.findAll", query = "SELECT t FROM TdoiDbPolFireWfEntity t")
public class TdoiDbPolFireWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_POL_FIRE_WF_ID", unique = true, nullable = false)
