...
/**
 * The persistent class for the TDOI_DB_PROPSL_FIRE_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_PROPSL_FIRE_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropslFireWfEntity.findAll", query = "SELECT t FROM TdoiDbPropslFireWfEntity t")
public class TdoiDbPropslFireWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_PROP_FIRE_WF_ID", unique = true, nullable = false)
	private long dbPropFireWfId;
	...
	public TdoiDbPropslFireWfEntity() {
	}

	public long getDbPropFireWfId() {
		return this.dbPropFireWfId;
	}

	public void setDbPropFireWfId(long dbPropFireWfId) {
		this.dbPropFireWfId = dbPropFireWfId;
	}
