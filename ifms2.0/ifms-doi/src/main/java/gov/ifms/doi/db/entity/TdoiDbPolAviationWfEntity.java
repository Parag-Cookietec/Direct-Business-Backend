...
/**
 * The persistent class for the TDOI_DB_POL_AVIATION_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_POL_AVIATION_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPolAviationWfEntity.findAll", query = "SELECT t FROM TdoiDbPolAviationWfEntity t")
public class TdoiDbPolAviationWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_POL_AVIATION_WF_ID", unique = true, nullable = false)
	private long dbPolAviationWfId;
	...
	public TdoiDbPolAviationWfEntity() {
	}

	public long getDbPolAviationWfId() {
		return this.dbPolAviationWfId;
	}

	public void setDbPolAviationWfId(long dbPolAviationWfId) {
		this.dbPolAviationWfId = dbPolAviationWfId;
	}
