...
/**
 * The persistent class for the TDOI_DB_PROPSL_AVIATION_WF database table.
 * 
 */
@Entity
@Table(name = "TDOI_DB_PROPSL_AVIATION_WF", schema = DoiJPAConstants.DOI_SCHEMA)
@NamedQuery(name = "TdoiDbPropslAviationWfEntity.findAll", query = "SELECT t FROM TdoiDbPropslAviationWfEntity t")
public class TdoiDbPropslAviationWfEntity extends BaseEntity {
	private static final long serialVersionUID = 1L;

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "DB_PROPSL_AVIATION_WF_ID", unique = true, nullable = false)
	private long dbPropslAviationWfId;
	...
	public TdoiDbPropslAviationWfEntity() {
	}

	public long getDbPropslAviationWfId() {
		return this.dbPropslAviationWfId;
	}

	public void setDbPropslAviationWfId(long dbPropslAviationWfId) {
		this.dbPropslAviationWfId = dbPropslAviationWfId;
	}
