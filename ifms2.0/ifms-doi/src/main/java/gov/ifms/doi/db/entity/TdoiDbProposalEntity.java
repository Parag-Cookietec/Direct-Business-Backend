...
public class TdoiDbProposalEntity extends BaseEntity {
	...
	@OneToMany(mappedBy = "tdoiDbProposal", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPolFireBuildingValEntity> tdoiDbPolFireBuildingValEntities;

	@OneToMany(mappedBy = "tdoiDbProposal", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPolFirePastPolicyEntity> tdoiDbPolFirePastPolicyEntities;

	@OneToMany(mappedBy = "tdoiDbProposal", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPolFireRiskLocEntity> tdoiDbPolFireRiskLocEntities;

	@OneToMany(mappedBy = "tdoiDbProposal", fetch = FetchType.LAZY, cascade = CascadeType.ALL)
	@JsonManagedReference
	private List<TdoiDbPolFireSumInsuredEntity> tdoiDbPolFireSumInsuredEntities;
	...
	public List<TdoiDbPolFirePastPolicyEntity> getTdoiDbPolFirePastPolicyEntities() {
		return tdoiDbPolFirePastPolicyEntities;
	}

	public void setTdoiDbPolFirePastPolicyEntities(List<TdoiDbPolFirePastPolicyEntity> tdoiDbPolFirePastPolicyEntities) {
		this.tdoiDbPolFirePastPolicyEntities = tdoiDbPolFirePastPolicyEntities;
	}

	public List<TdoiDbPolFireRiskLocEntity> getTdoiDbPolFireRiskLocEntities() {
		return tdoiDbPolFireRiskLocEntities;
	}

	public void setTdoiDbPolFireRiskLocEntities(List<TdoiDbPolFireRiskLocEntity> tdoiDbPolFireRiskLocEntities) {
		this.tdoiDbPolFireRiskLocEntities = tdoiDbPolFireRiskLocEntities;
	}

	public List<TdoiDbPolFireSumInsuredEntity> getTdoiDbPolFireSumInsuredEntities() {
		return tdoiDbPolFireSumInsuredEntities;
	}

	public void setTdoiDbPolFireSumInsuredEntities(List<TdoiDbPolFireSumInsuredEntity> tdoiDbPolFireSumInsuredEntities) {
		this.tdoiDbPolFireSumInsuredEntities = tdoiDbPolFireSumInsuredEntities;
	}
	...
	public List<TdoiDbPolFireBuildingValEntity> getTdoiDbPolFireBuildingValEntities() {
		return tdoiDbPolFireBuildingValEntities;
	}

	public void setTdoiDbPolFireBuildingValEntities(List<TdoiDbPolFireBuildingValEntity> tdoiDbPolFireBuildingValEntities) {
		this.tdoiDbPolFireBuildingValEntities = tdoiDbPolFireBuildingValEntities;
	}
